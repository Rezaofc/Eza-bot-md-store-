...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6289606790112@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
if (connection){
if (connection != "connecting") console.log("Connecting to Eza bot..")
}
console.log(up)
...
sendMessage(`6289606790112@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"url": `https://youtube.com/@MrReza18`,
"productImageCount": 1,
