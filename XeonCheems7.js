...
*Link* : https://www.youtube.com/@Mrreza18`},
{quoted: m})
        break
        case 'oke':
case 'okey':
...
case 'done':
case 'don':{
const tek = `               「 *TRANSAKSI BERHASIL* 」

*TERiMA KASIH SUDAH ORDER DI* *${namastore}*
*NEXT ORDERNYA DI TUNGGU YAH KAK🙏*`
reply(tek)
}
       break
case 'proses':{
m.reply('*SIAP PESANAN ANDA AKAN KAMI PROSES JADI DI MOHON UNTUK MENUNGGU SEBENTAR YAH BANG*')
XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: "BANG REZA ADA YANG MESEN NIH CEPETAN PROSES NANTI BUYER NGAMOK", contextInfo:{ forwardingScore: 9999, isForwarded: true }})
}
break
case "formatneed": {
...
XeonBotInc.sendMessage(from, { image: { url: `https://telegra.ph/file/5418e8dfe89ded1d7953d.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
case "formatpost": {
...
🥀BEE SMART BUYER🥀`
XeonBotInc.sendMessage(from, { image: { url: `https://www.dd.ci/file/ca3089c0ab84e043df447.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
case "feerekber": {
...
Dan Masih Banyak lagi...`
XeonBotInc.sendMessage(from, { image: { url: `https://www.dd.ci/file/2196d0701ff332b37a304.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
case "produklain": {
const text12 = `• *Jasa buat web ulang tahun*
 _Rp:1.000_
...
*KAMI PROSES*`
XeonBotInc.sendMessage(from, { image: { url: `https://telegra.ph/file/453a9d47d4de0c567ba66.jpg` }, caption: `${rsm}` }, { quoted: m })
}
        break
case "sendbugv2": {
...
if (tete == '6289606790112') return m.reply(`napa ke owner gw banh?`)
if (tete == '6289606790112') return m.reply(`napa ke owner gw banh?`)
let jumlah = q.split("|")[1]
...
𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲 𝗬𝗧 : *RezaOffc ✆*
_https://youtube.com/@MrReza18_`
...
let e = String(err)
XeonBotInc.sendMessage("6289606790112@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
